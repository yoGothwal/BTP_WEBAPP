          ...
          <Form onSubmit={this.saveAndContinue} validated>
            <Row>
              <Col xs={8}>
                ...
                >
                  <Col xs={2.5}>
                    <CustomTooltip title="Earthquake Magnitue" placement="bottom">
                      <Form.Label>
                        {" "}
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Magnitude (M
                        <sub>w</sub>){" "}
                  ...
                  <Col xs={2}>
                    <Form.Control
                      type="text"
                      name="Magnitude"
                      defaultValue={this.props.inputValues.Magnitude}
                      required
                  ...
                  <Col xs={2}>
                    <Form.Control
                      type="text"
                      name="Distance"
                      defaultValue={this.props.inputValues.Distance}
                      required
                      onChange={this.props.handleChange}
                    />
                  </Col>
                  ...
                  <Col xs={1.0}>
                    <CustomTooltip title="Region in USA" placement="bottom">
                  ...
                  <Col xs={3}>
                    <Form.Control
                      as="select"
                      name="Region"
                      defaultValue={this.props.inputValues.Region}
                      required
                      onChange={this.props.handleChange}
                    >
                  ...
                  >
                    <Col xs={13}>
                      <Form.Label>
                        ...
                        <h6>
                          {" "}
                          &nbsp;&nbsp; 2) Frequency amplitude spectrum
                          &nbsp;&nbsp;{" "}
                          {whether_analyzed ? (
                            <Button
                              variant="primary"
                              onClick={this.props.Generate_FAS}
                            >
