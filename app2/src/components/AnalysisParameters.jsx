...
const Analysis_Settings = ({
  ...
  console.log(inputValues.whether_analyzed);
        ...
        >
                  ...
                  <CardContent>
                    ...
                    >
                      <FormControl fullWidth>
                        <InputLabel id="analysis-type-label">
                          Analysis Type
                        </InputLabel>
                        <Select
                          labelId="analysis-type-label"
                          id="analysis-type-select"
                          value={inputValues.Analysis_Type}
                          label="Analysis Type"
                          onChange={handleChange}
                          name="Analysis_Type"
                          required
                        >
                          <MenuItem value="EQL">Equivalent linear</MenuItem>
                          {/* <MenuItem value="LE">Linear elastic</MenuItem> */}
                        </Select>
                      </FormControl>
                    </Tooltip>
                  </CardContent>
          ...
          >
            ...
            <Button variant="contained" type="submit">
              {inputValues.whether_analyzed !== 2 ? (
                <>
